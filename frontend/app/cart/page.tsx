...
export default function CartPage() {
  const { items, totalItems, addItem, removeItem, clearCart } = useCart();
  ...
  const WHATSAPP_NUMBER = '905488616466';
  ...
  const handleWhatsAppCheckout = () => {
    ...
    message += `\n🙏 Thank you for ordering from BEAMS!`;
            ...
            <>
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  ...
                  />
                  <textarea
                    placeholder="Special instructions (e.g., extra hot, no sugar, etc.)"
              ...
              >
                <div style={{
                  ...
                  <motion.span
                    key={totalPrice}
                    initial={{ scale: 1.2, color: 'var(--blue)' }}
                    animate={{ scale: 1, color: 'var(--blue)' }}
                    transition={{ duration: 0.2 }}
                    style={{
                      fontFamily: 'Space Mono, monospace',
                      fontSize: '24px',
                ...
                <div style={{ display: 'flex', gap: '12px', flexDirection: 'column' }}>
                  ...
                  <p style={{
                    ...
                    💬 Click to send your order via WhatsApp. You'll be redirected to WhatsApp to confirm.
                  </p>
                </div>
              </motion.div>
            </>
